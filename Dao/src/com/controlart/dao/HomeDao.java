...
import com.controlart.transfer.TransacaoInfoT;
...
public class HomeDao {
	...
	public List<TransacaoInfoT> consultTransacao() throws SQLException {
		PreparedStatement pStmt = null;
		ResultSet rs = null;
	...
	private List<TransacaoInfoT> resultsetToObjectTransacao(ResultSet rs)
			throws SQLException {
		List<TransacaoInfoT> listaTransacaoT = new ArrayList<TransacaoInfoT>();

		while (rs.next()) {
			TransacaoInfoT transacaoT = new TransacaoInfoT();
