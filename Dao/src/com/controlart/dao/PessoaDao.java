...
public class PessoaDao {
	...
	private static final String SQL_CONSULT_ALL_WITHOUT_USER 	= "SELECT tp.id_pessoa, tp.nm_pessoa FROM tb_pessoa tp WHERE tp.id_pessoa NOT IN (SELECT tu.id_pessoa FROM tb_usuario tu)";
